...
function factory(Object, Promise, shim_array, jjv, jjve, MarcRecord, schema_configuration, schema_validate_results, schema_fix_results)
{
        ...
        function runValidators(validators, results)
        {
          ...
          if (!validator) {
            ...
            return validator.validate(record).then(function(results_validate) {
              ...
              validateValidateResults(result.validate);
