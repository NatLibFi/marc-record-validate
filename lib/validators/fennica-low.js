...
function factory(shim_array)
{
  ...
  function hasInvalid008(record)
  {
    ...
    // 008:n merkkipaikka 39 po. '^', jos Fennican LOW-tag läsnä    
    if (field_008) {
      ...
      if (hasLowFenni(record)) {
        ...
        if (hasInvalidLeader(record)) {
          ...
          results.push({
            modifications: [{
              ...
              newValue: value_new_leader
            }]
          });

          record.leader = value_new_leader;
        ...
        if (hasInvalid008(record)) {
          ...
          results.push({
            ...
            modifications: [{
              type: 'modifyField',
              oldValue: field_008.value,
              newValue: value_new_008
            }]
          });
